...
const inputStyles = {
  label: cj({
    base: ['bg-zinc-200',"p-2", "flex flex-col", "gap-y-1", "outline outline-0 outline-zinc-400 rounded-sm","focus-within:outline-1", "[&_span]:focus-within:font-bold"],
    focus: {
      green: "focus-within:outline-emerald-500 [&_span]:focus-within:text-emerald-500",
      blue: "focus-within:outline-blue-500 [&_span]:focus-within:text-blue-500",
      yellow: "focus-within:outline-yellow-500 [&_span]:focus-within:text-yellow-500",
