...
import "../../assets/styles/page_styles/07-Collection/collection.css";
...
const Collection = () => {
  const [linkCollection, setLinkCollection] = useState([
    {
      id: 1,
      link: "fa8ad3",
      description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quae, sit.",
  ...
  return (
    <Container id="collection" className="grid">
      ...
      <p className="info">Tambah, Edit, Hapus, dan Bagikan Tautan yang kamu miliki</p>
      <div className="cards">
